        ...
        .row.g-0
          ...
          .col-xl-6.info-section
            .content-wrapper.px-lg-4.pt-lg-4.px-xxl-5.py-xxl-5.text-start
              ...
              p.descripcion.mb-4 La unidad aborda la higiene y seguridad en el trabajo con infantes en contextos escolares, destacando la importancia de crear ambientes seguros y saludables. Se analizan riesgos físicos, biológicos y psicosociales para niños y personal educativo, proponiendo medidas preventivas y normativas vigentes en Colombia. Se promueve el uso del Sistema de Gestión de Seguridad y Salud en el Trabajo (SG-SST) y la capacitación continua para fomentar una cultura de autocuidado. Se detallan protocolos de prevención de accidentes, evaluación de riesgos y diseño seguro de espacios, priorizando el bienestar integral infantil.
